				...
				<el-form :model="searchQuery" class="search_form" >
					<div class="search_view">
						...
						<div class="search_box">
							<el-input class="search_inp" v-model="searchQuery.nongminzhanghao" placeholder="农民账号"
								clearable>
							</el-input>
						</div>
					</div>
...
<script setup>
	...
	const getList = () => {
		...
		params['sort'] = 'id'
		params['order'] = 'desc'
		if(searchQuery.value.nongminzhanghao&&searchQuery.value.nongminzhanghao!=''){
			params['nongminzhanghao'] = '%' + searchQuery.value.nongminzhanghao + '%'
		}
		context?.$http({
			url: `${tableName}/page`,
			method: 'get',
