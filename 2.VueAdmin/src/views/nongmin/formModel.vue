				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="农民密码" prop="nongminmima">
							<el-input class="list_inp" v-model="form.nongminmima" placeholder="农民密码"
								type="password" :readonly="!isAdd||disabledForm.nongminmima?true:false" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='nongminmima'){
					form.value.nongminmima = row[x];
					disabledForm.value.nongminmima = true;
					continue;
				}
