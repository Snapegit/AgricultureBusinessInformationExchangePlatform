		...
		<el-dialog v-model="formVisible" :title="formTitle" width="50%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="商户名称" prop="nongminzhanghao">
							<el-input class="list_inp" v-model="form.nongminzhanghao" placeholder="商户名称"
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.logistics = res.data.data.logistics?(res.data.data.logistics.replace(reg,'../../../cl15067209/file')):'';
