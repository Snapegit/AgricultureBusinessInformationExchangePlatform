		...
		<el-dialog v-model="formVisible" :title="formTitle" width="50%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="24">
						<el-form-item prop="dianputupian"
									  label="店铺图片"
						>
							<uploads
					...
					<el-col :span="12">
						<el-form-item label="售卖产品" prop="shoumaichanpin">
							<el-input v-model="form.shoumaichanpin" placeholder="售卖产品" type="textarea"
							:readonly="!isAdd||disabledForm.shoumaichanpin?true:false"
							/>
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="店铺详情" prop="dianpuxiangqing">
							<editor :value="form.dianpuxiangqing" placeholder="请输入店铺详情" :readonly="!isAdd||disabledForm.dianpuxiangqing?true:false"
								class="list_editor" @change="(e)=>editorChange(e,'dianpuxiangqing')"></editor>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.dianpuxiangqing = res.data.data.dianpuxiangqing?(res.data.data.dianpuxiangqing.replace(reg,'../../../cl15067209/file')):'';
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='shoumaichanpin'){
					form.value.shoumaichanpin = row[x];
					disabledForm.value.shoumaichanpin = true;
					continue;
				}
				if(x=='dianpuxiangqing'){
					form.value.dianpuxiangqing = row[x];
					disabledForm.value.dianpuxiangqing = true;
					continue;
				}
		...
		:deep(.el-form-item) {
			...
			.el-form-item__content {
				...
				.el-textarea__inner {
					...
					border-radius: 0;
					padding: 12px 24px;
					clip-path: polygon(97% 0, 100% 53%, 97% 100%, 3% 100%, 0% 50%, 3% 0);
					color: #333;
					background: #eee;
					width: 100%;
					font-size: 14px;
