	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discussnongchanpinxinxi`, this.ruleForm.id);
...
//跨表计算判断
				...
				if(crossrefid && crossuserid) {
					...
					let res = await this.$api.list(`discussnongchanpinxinxi`, params);
                ...
                //跨表计算
						if(this.ruleForm.id){
							await this.$api.update(`discussnongchanpinxinxi`, this.ruleForm);
						}else{
							await this.$api.add(`discussnongchanpinxinxi`, this.ruleForm);
						}
						uni.setStorageSync('discussnongchanpinxinxiCleanType',true);
